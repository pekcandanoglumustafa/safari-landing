...
export default function FloatingWhats() {
  return (
    <a href={CONTACT.whatsapp} target="_blank" rel="noopener" data-wa="1" aria-label="WhatsApp'tan yazın"
      className="fixed bottom-24 right-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25d366] shadow-xl shadow-black/25 transition hover:scale-105 md:bottom-6">
